...

{
  ...
  # manage.
  home.username = "hieule";
  home.homeDirectory = "/home/hieule";
  ...
  home.packages = [
    ...
    # '')
    ( pkgs.tela-circle-icon-theme.override { colorVariants = ["red" "pink" "ubuntu"]; })
  ];
  ...
  # or
  #
  #  /etc/profiles/per-user/hieule/etc/profile.d/hm-session-vars.sh
  #
  ...
  programs.zsh = {
    ...
    shellAliases = {
        ...
        codeconfig = "code /etc/nixos/configuration.nix";
    };
    history.save = 100000;
